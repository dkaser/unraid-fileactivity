 ...
 *   https://datatables.net/download/#ju/dt-2.3.2/b-3.2.3/cc-1.0.4/date-1.5.5/rg-1.5.1
 *
 * Included libraries:
 *   DataTables 2.3.2, Buttons 3.2.3, ColumnControl 1.0.4, DateTime 1.5.5, RowGroup 1.5.1
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "ju/dt-2.3.2/b-3.2.3/cc-1.0.4/date-1.5.5/rg-1.5.1",
