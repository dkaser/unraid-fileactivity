...
<table id='logTable' class="stripe">
    <thead>
        <tr>
...
$(document).ready( function () {
    $('#logTable').DataTable({
        ajax: {
            url: '/plugins/file.activity/data.php/share',
            dataSrc: ''
        },
        columns: [
        ...
        initComplete: function () {
            this.api()
                ...
                .every(function () {
                    ...
                    var select = $('<select id="' + title + '" class="select2" ></select>')
                        .appendTo($("#logTable thead tr:eq(1) th").eq(column.index()).empty())
                        .on( 'change', function () {
            ...
            this.api()
                ...
                .every(function () {
                    ...
                    $("#logTable thead tr:eq(1) th").eq(column.index()).empty().append(input);
